...
public class CrewSkillsModule {
    ...
    @Provides
    @CrewSkillsScope
    ICrewSkillsRepository provideCrewSkillsRepository(IApiService service) {
        return new CrewSkillsRepository(service);
    }
    ...
    ICrewSkillsPresenter provideCrewSkillsPresenter(ICrewSkillsInteractor interactor,
        ...
        return new CrewSkillsPresenter(interactor, rxSchedulersAbs, validator);
    }
